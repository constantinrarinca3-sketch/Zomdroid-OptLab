...
typedef struct {
    ...
    unsigned int safe_head;
    unsigned int safe_tail;
    atomic_ulong enqueued;
    atomic_ulong dropped;
    atomic_ulong coalesced;
} ZomdroidEventQueue;

extern ZomdroidEventQueue g_zomdroid_event_queue;
extern bool g_zomdroid_input_mutex_safe;
extern bool g_zomdroid_input_analog_filter;
extern bool g_zomdroid_input_coalesce;
...
extern bool g_zomdroid_surface_gen_ack;
