...
android {
    ...
    defaultConfig {
        ...
        manifestPlaceholders["optLabAppLabel"] = "ZomDroid OPT LAB R6 QA"
    ...
    productFlavors {
        ...
        create("replaceR1") {
            ...
            versionCode = 14747
            versionName = "1.4.7v4-optlab-r6-cp1-qa-mgl12-replace"
            manifestPlaceholders["optLabAppLabel"] = "ZomDroid OPT LAB R6 QA Replace"
        }
    }
