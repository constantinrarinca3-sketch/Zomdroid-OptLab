...
public final class Main {
    ...
    public static void premain(String args, Instrumentation instrumentation) {
        ...
        System.out.println("[ZD-OPT-LAB-AGENT] version=16 schema=15 loaded");
        ...
        boolean anyRequested = pacingRequested || wakeRequested || queueRequested
                || lookaheadRequested || dirtyDedupRequested
                || fboInnerLoopRequested || chunkForageRequested
        ...
        try {
            ...
            FboRuntime.configure(dirtyDedup.isCandidate());
            ...
            if (wake.isCandidate() || queueFast.isCandidate()) {
                        ...
                        .transform((target, type, loader, module, domain) -> {
                            ...
                            if (applyWake) {
                                target = target.visit(Advice.to(StreamSignalAdvice.class).on(
                                        streamSignalMatcher()));
                                wake.passPart("world_streamer_signal");
                            }
                            return target;
                        });
            }
