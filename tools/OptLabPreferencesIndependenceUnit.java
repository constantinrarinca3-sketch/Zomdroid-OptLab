...
public final class OptLabPreferencesIndependenceUnit {
    public static void main(String[] args) {
        ...
        require(prefs.build42FeatureEnabledCount() == 0,
                "Build 42 Safe profile must be a real ALL OFF profile");
        ...
        require(prefs.isFboDirtyDedup(), "FBO dirty dedup preset active");
        ...
        require(!restarted.isFboDirtyDedup(), "FBO dirty dedup re-armed after restart");
