...
public final class OptLabLaunchContractUnit {
    public static void main(String[] args) {
        ...
        OptLabLaunchContract.putProperty(jvm, "zomdroid.optlab.fbo.frame.budget", "0");
        ...
        require("0".equals(OptLabLaunchContract.valueOf(jvm,
                "zomdroid.optlab.fbo.frame.budget")), "FBO OFF missing");
        require("0".equals(OptLabLaunchContract.valueOf(jvm,
        ...
        OptLabLaunchContract.requireValue(jvm, "zomdroid.optlab.fbo.frame.budget", "0");
