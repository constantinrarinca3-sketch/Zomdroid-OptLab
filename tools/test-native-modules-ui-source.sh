...
assert 'popMan.setEnabled(false)' in native, 'PopMan must stay disabled'
...
assert 'Unavailable' in values['native_modules_popman_unavailable']
print('NATIVE_MODULES_UI_SOURCE PASS separate_dialogs=2 real_toggles=3 popman_disabled=1')
PY
