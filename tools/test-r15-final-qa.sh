...
rg -o '"zomdroid\.optlab\.[^"]+"' \
  ...
  "$PROJECT_DIR/optlab_deps/zomdroid-dependencies-4da905a55889778a2a7a38f268e36b8bc595a8a5/zomdroid-agent/src/main/java/com/zomdroid/agent/optimization/FeatureCompatibility.java" \
...
run bash "$PROJECT_DIR/tools/test-optlab-launch-contract.sh"
run bash "$PROJECT_DIR/tools/test-optlab-process-isolation.sh"
